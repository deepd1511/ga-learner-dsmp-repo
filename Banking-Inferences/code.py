...
for i in range(len(sample_size)):
    ...
    for j in range(1000):
        print(j)
        sample_size_1 = sample_size[i]
        sampled_data = data.sample(n=sample_size_1)
        m.append(sampled_data['installment'].mean())
...
observed = pd.concat([yesT,noT],axis=1,keys = ['Yes','No'])
print(observed)
